...
% --- LAYERNORM ---
\begin{tcolorbox}[colback=gray!5, colframe=gray!60!black, title=\textbf{Co robi LayerNorm?}]

W równaniu widzimy, że przed Attention i MLP stosujemy $\text{LayerNorm}(\mathbf{h})$.
